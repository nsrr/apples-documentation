...
[Covariate csv files](:files_path:/datasets) (apples-dataset-0.1.0.csv and apples-harmonized-dataset-0.1.0.csv) contain data on 1,516 subjects from up to seven research visits. The [appleid](:variable_path:/appleid) column is the unique APPLES identifier. The [visitn](:variable_path:/visitn) column distinguishes different research visits, and the [fileid](:variable_path:/fileid) column links covariate datasets to diagnostic PSG files.
